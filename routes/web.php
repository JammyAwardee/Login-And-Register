...
Route::get('/newsupdates', [BarangayOfficialsController::class, 'activeofficials']);

// Route::get('/barangayofficials', [BarangayOfficialsController::class, 'barangayofficials']);
