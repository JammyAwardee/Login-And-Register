        ...
        <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-2xl">
            ...
            <div class="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                    ...
                    <li>
                        <a href="{{ url('/residents') }}" class="block py-2 pr-4 pl-3 text-gray-200 border-b border-gray-100  hover:text-amber-50 lg:border-0 lg:hover:text-primary-700 lg:p-0">Residents</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="{{ url('/newsandupdates') }}" class="block py-2 pl-3 text-gray-200 border-b border-gray-100 hover:text-amber-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0">News And Updates</a>
                    </li>
                    <li>
