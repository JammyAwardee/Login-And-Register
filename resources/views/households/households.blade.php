                  ...
                  <thead class="bg-white border-b">
                    ...
                    @foreach($households as $household)
                      <tr class="bg-white border-b transition duration-300 ease-in-out hover:bg-gray-100">
                        ...
                        <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                            <a href="/households/{{$household->id}}/edit" class="inline, text-yellow-600 text-lg mr-6"><i class="fa-solid fa-pen"></i></a> <button class="inline text-red-700 text-lg" role="button" data-bs-toggle="modal" data-bs-target="#exampleModalCenter" data-bs-att="/households/{{$household->id}}"><i class="fa-solid fa-trash-can"></i></button>
                        </td>
                      </tr>
                          ...
                          <div class="modal-content border-none shadow-lg relative flex flex-col w-full pointer-events-auto bg-white bg-clip-padding rounded-md outline-none text-current">
                            <div class="modal-header flex flex-shrink-0 items-center justify-between p-4 border-b border-gray-200 rounded-t-md">
                              <h5 class="text-xl font-medium leading-normal text-gray-800" id="exampleModalScrollableLabel">
                                Delete Household Id # {{$household->id}}
                              </h5>    
                              <button type="button"
                            ...
                            <div
                              ...
                              <form method="POST" action="/households/{{$household->id}}">
                                @csrf
                                @method('DELETE')
                              <button type="submit"
