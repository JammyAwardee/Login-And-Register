        ...
        <div class="max-w-full mx-auto shadow-lg">
            ...
            <section class="flex flex-col break-words bg-[url('/images/lightpaperfibers.png')] border-1 rounded-md shadow-lg">
                ...
                <div class="grid grid-cols-10 gap-1">
                    ...
                    <div class="col">
                        <input type="number" name="id" id="id"  class="bg-gray-50 border-none text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" value= "{{$household->id}}" >
                    </div>
                    <div class="col-span-4 ">
                        <input type="text" name="fullname" id="fullname"  class="bg-gray-50 border-none text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" value= "{{$household->household_head}}">
                    </div>
                    <div class="col-span-4">
                        <input type="text" name="fullname" id="fullname"  class="bg-gray-50 border-none text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" value= "{{$household->street_address}}">
                    </div>
                    <a href="/residents/addhousehold/{{$household->id}}/createresidenthelper" class="flex items-center justify-center w-full bg-gray-100 rounded-md text-gray-800 hover:bg-gray-300 hover:text-blue-700">
            ...
            @endunless
                ...
                <form action="/residents/{{$resident->id}}/storehousehold" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="grid gap-4 pb-4 sm:grid-cols-2 xl:grid-cols-4 grid-cols-1">
                        ...
                        <div>
                            ...
                            <input type="number" name="household_id" id="household_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Enter Household Id" value={{$data['id']}}>
                            @error('household_id')
                                <p class="text-red-500 text-xs mt-2">
                                    {{$message}}
                                </p>
                        ...
                        <div>
                            ...
                            <input type="text" name="household_head" id="household_head" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Enter Household Head" disabled value="{{$data['fullname']}}">
                        ...
                        <div>
                            <label for="relation_to_head" class="block mb-2 text-sm font-medium text-gray-900">Relation to Household Head</label>
                            <input type="text" name="relation_to_head" id="relation_to_head" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Enter Relation to Household Head" value={{old('relation_to_head')}}>
